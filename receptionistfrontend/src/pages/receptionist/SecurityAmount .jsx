...
function SecurityAmount() {
  ...
  const handleSearch = (event) => {
    ...
    const filteredResults = securityList.filter(
      (row) =>
        row?.patient_name.toLowerCase().includes(searchTerm.trim()) ||
        row?.patient_number.includes(searchTerm.trim()) ||
  ...
  const currentRows = searchTerm
    ...
    : securityList.slice(indexOfFirstRow, indexOfLastRow);
  ...
  <ul class="dropdown-menu">
    ...
    <li><a class="dropdown-item" href="#">All</a></li>
      ...
      {/* pop-up for refund amount */}
      <div className={`popup-container${showEditSecAmount ? " active" : ""}`}>
        <div className="popup">
      ...
      <div className={`popup-container${showPaySecAmount ? " active" : ""}`}>
        <div className="popup">
